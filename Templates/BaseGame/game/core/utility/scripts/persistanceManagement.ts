...
function TestPManager::testNewObject(%doNotSave)
{
   ...
   // Flag it as dirty
   TestPManager.setDirty(AudioNew, "core/scripts/client/audio.ts");
   ...
   // Flag it as dirty
   TestPManager.setDirty(%obj, "core/scripts/client/audio.ts");

   // Test adding an "empty" object
   new SFXDescription(AudioEmpty);

   TestPManager.setDirty(AudioEmpty, "core/scripts/client/audio.ts");
...
function TestPManager::testNewGroup(%doNotSave)
{
   ...
   // Flag this as dirty
   TestPManager.setDirty(TestGroup, "core/scripts/client/audio.ts");
   ...
   // Flag this as dirty
   TestPManager.setDirty(%group, "core/scripts/client/audio.ts");
   ...
   // Flag this as dirty
   TestPManager.setDirty(%set, "core/scripts/client/audio.ts");
...
function TestPManager::testMoveObject(%doNotSave)
{
   ...
   // Flag this as dirty
   TestPManager.setDirty(MoveGroup1, "core/scripts/client/audio.ts");
   ...
   // Flag this as dirty
   TestPManager.setDirty(MoveGroup2, "core/scripts/client/audio.ts");
