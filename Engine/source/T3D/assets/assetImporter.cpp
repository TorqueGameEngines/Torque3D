...
AssetImportConfig::AssetImportConfig() :
   ...
   importImages(true),
   ImageType("GUI"),
   DiffuseTypeSuffixes("_albedo,_d,_basecolor"),
   NormalTypeSuffixes("_normal,_n"),
   MetalnessTypeSuffixes("_metal"),
   RoughnessTypeSuffixes("_rough"),
   SmoothnessTypeSuffixes("_smooth"),
   AOTypeSuffixes("_ao,_AO"),
   PBRTypeSuffixes("_comp,_composite"),
